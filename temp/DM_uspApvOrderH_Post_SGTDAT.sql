...
/****** Object:  StoredProcedure [dbo].[DM_uspApvOrderH_Post_SGTDAT]    Script Date: 11/24/2017 16:08:42 ******/
SET ANSI_NULLS ON
GO
	...
	--begin	
		...
		declare cHeader cursor for
			select 
				...
				,case when isnull(a.nama_tagih, '') = '' then b.namecust else upper(a.nama_kirim) end as bilname
				,case when isnull(a.alamat_tagih, '') = '' then b.textstre1 else upper(substring(a.alamat_kirim, 1, 60)) end as biladdr1
				,case when isnull(a.alamat_tagih, '') = '' then b.textstre2 else upper(substring(a.alamat_kirim, 61, 60)) end as biladdr2
				,case when isnull(a.alamat_tagih, '') = '' then b.textstre3 else upper(substring(a.alamat_kirim, 121, 60)) end as biladdr3
				,case when isnull(a.alamat_tagih, '') = '' then b.textstre4 else upper(substring(a.alamat_kirim, 181, 60)) end as biladdr4
				,case when isnull(a.kota_tagih, '') = '' then b.namecity else upper(a.kota_kirim) end as bilcity
				,case when isnull(a.propinsi_tagih, '') = '' then b.codestte else upper(a.propinsi_kirim) end as bilstate
				,b.codepstl as bilzip
				,b.codectry as bilcountry
				,case when isnull(a.telp_tagih, '') = '' then b.textphon1 else upper(a.telp_kirim) end as bilphone
				,case when isnull(a.hp_tagih, '') = '' then b.textphon2 else upper(a.hp_kirim) end as bilfax
				,b.namectac as bilcontact
				,case when isnull(a.nama_kirim, '') = '' then b.namecust else upper(a.nama_kirim) end as shpname
				,case when isnull(a.alamat_kirim, '') = '' then b.textstre1 else upper(substring(a.alamat_kirim, 1, 60)) end as shpaddr1
				,case when isnull(a.alamat_kirim, '') = '' then b.textstre2 else upper(substring(a.alamat_kirim, 61, 60)) end as shpaddr2
				,case when isnull(a.alamat_kirim, '') = '' then b.textstre3 else upper(substring(a.alamat_kirim, 121, 60)) end as shpaddr3
				,case when isnull(a.alamat_kirim, '') = '' then b.textstre4 else upper(substring(a.alamat_kirim, 181, 60)) end as shpaddr4
				,case when isnull(a.kota_kirim, '') = '' then b.namecity else upper(a.kota_kirim) end as shpcity
				,case when isnull(a.propinsi_kirim, '') = '' then b.codestte else upper(a.propinsi_kirim) end as shpstate
				,b.codepstl as shpzip
				,b.codectry as shpcountry
				,case when isnull(a.telp_kirim, '') = '' then b.textphon1 else upper(a.telp_kirim) end as shpphone
				,case when isnull(a.hp_kirim, '') = '' then b.textphon2 else upper(a.hp_kirim) end as shpfax
				,b.namectac as shpcontact
				,case when isnull(a.po_referensi, '') = '' then '' else upper(a.po_referensi) end as ponumber
