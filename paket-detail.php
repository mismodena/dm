...
$rs_paket_detail = sql_dm::cari_paket( array( "b.paketid" => array("=", "'". main::formatting_query_string($_REQUEST["paketid"]) ."'") ) );
...
$rs_paket_parameter = sql_dm::browse_paket_parameter( array( "b.paketid" => array("=", "'". main::formatting_query_string($_REQUEST["paketid"]) ."'") ) );
...
$rs_paket_item = sql_dm::browse_paket_item( array( "b.paketid" => array("=", "'". main::formatting_query_string($_REQUEST["paketid"]) ."'") ) );
