...
class reward_diskon_rupiah_1_item_perdana{	
	
	public $maksimal_pengali = 1;
	...
	function __construct( $obyek_dm, $arr_parameter ){
		...
		foreach($obyek_dm->arr_item_dengan_paket as $arr_item_dengan_paket){
			...
			if( $item_seq == $arr_parameter[ "item_seq" ] ){
				$obyek_dm->arr_item_diskon[  $arr_parameter[ "item_seq" ] ][ $arr_parameter["paketid"] ] = $pengali * $arr_parameter[ "nilai_reward" ] * $arr_parameter[ "kuantitas" ];
				break;
			}
