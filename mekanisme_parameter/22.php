...
class porsi_nilai_order_pembelian_kombinasi_kuantitas_dan_nominal extends sql_dm{
	...
	function __construct( $obyek_dm, $arr_parameter ){
		...
		$this->porsi_nilai_order_pembelian_kombinasi_kuantitas_dan_nominal = ( $total_item_paket / ( $total_item_paket + $total_item_non_paket ) ) . ";" . $kuantitas . ";" . $nominal ;
