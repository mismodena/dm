...
class akumulasi_kuantitas_order_3_invoice extends sql_dm{
	
	public 
		$akumulasi_kuantitas_order_3_invoice = 0,
	...
	function __construct( $obyek_dm, $arr_parameter ){
		...
		while( $data_invoice = sqlsrv_fetch_array( $rs_data_invoice ) ){
			...
			$this->akumulasi_kuantitas_order_3_invoice += $data_invoice["kuantitas"];
