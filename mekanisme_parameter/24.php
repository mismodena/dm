...
class kuantitas_item_campuran_akumulasi_batasan_kuantitas extends sql_dm{
	
	public $kuantitas_item_campuran_akumulasi_batasan_kuantitas;
	...
	function __construct( $obyek_dm, $arr_parameter ){
		...
		$total_kuantitas_item_paket = array_sum( array_values( $arr_item_paket ) );
		...
		$total_kuantitas_item_paket_terbatas = array_sum( array_values( $arr_paket_parameter_item ) );

		$this->kuantitas_item_campuran_akumulasi_batasan_kuantitas = $total_kuantitas_item_paket_terbatas / $total_kuantitas_item_paket;
