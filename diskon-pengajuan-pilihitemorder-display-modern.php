...
<input type="button" name="b_selesai" id="b_selesai" value="Pilih Item Order" onclick="__submit('diskon-pengajuan-pilihitemorder-display-modern.php', 'c=pilih_itemorder')" class="tombol-hijau"/>	
