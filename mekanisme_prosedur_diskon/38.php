...
class mekanisme_prosedur_diskon_38 extends prosedur_khusus_tambahan_diskon{
	private $mekanisme_prosedur_diskon = "", $script_dikembalikan = "";
	...
	function __construct( $arr_parameter ){
		...
		$js_parameter = "dealer_id=". str_replace("'", "", $arr_parameter["a3.dealer_id"][1]) ."&order_id=". str_replace("'", "", $arr_parameter["a.order_id"][1] ) ."&diskonid=38"; 
		
		$this->script_dikembalikan = "
		try{
			document.getElementById('b_item_38').setAttribute('onclick', 'location.href=\'diskon-pengajuan-pilihitemorder-display-modern.php?$js_parameter\'');
		}catch(e){}
		";
	...
	function script_dikembalikan(){
		return $this->script_dikembalikan;
	}
