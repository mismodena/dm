...
class mekanisme_prosedur_diskon_14 extends prosedur_khusus_tambahan_diskon{
	...
	function __construct( $arr_parameter, $readonly = "", $parameter_template = "", $arr_budget_diskon_tersedia_terkait = array() ){
		...
		$arr_rpl["#keterangan_bqtq#"] = "<div style=\"font-size:11px; float:left\">
			<sup>[1]</sup>. Pemakaian free item TQ yang sedang dalam proses pengajuan<br />
			<sup>[2]</sup>. Pemakaian free item TQ dari order lain yang sedang dalam proses pengajuan</div>";
