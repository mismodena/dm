...
class mekanisme_prosedur_diskon_49 extends prosedur_khusus_tambahan_diskon{

	private 
		$mekanisme_prosedur_diskon = "",
		$arr_diskon_id_saling_melengkapi = array(49),
		$arr_diskon_id_share_budget = array(49),
		$arr_diskon_id_sebudget = array(49),
		$diskon_id = 49,
		$template = "template/diskon-bqtq#readonly#.html",
		$ada_yg_blm_dialokasikan = false,
		$prefiks_identifikasi_bqtq = "bbt",
	...
	function __construct( $arr_parameter, $readonly = "", $parameter_template = "", $arr_budget_diskon_tersedia_terkait = array() ){
		...
		$pemakaian_tq = prosedur_khusus_tambahan_diskon::pemakaian_saldo_pusat( $arr_parameter["a.order_id"][1], $this->prefiks_identifikasi_bqtq )["pemakaian"];
		...
		$arr_rpl["#keterangan_bqtq#"] = "<div style=\"font-size:11px; float:left\">
			<sup>[1]</sup>. Pemakaian free item BBT yang sedang dalam proses pengajuan<br />
			<sup>[2]</sup>. Pemakaian free item BBT dari order lain yang sedang dalam proses pengajuan</div>";
		
		$pemakaian_tq_orderlain = prosedur_khusus_tambahan_diskon::pemakaian_saldo_pusat( $arr_parameter["a.order_id"][1], $this->prefiks_identifikasi_bqtq, false )["pemakaian"];
