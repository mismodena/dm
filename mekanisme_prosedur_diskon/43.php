...
class mekanisme_prosedur_diskon_43 extends prosedur_khusus_tambahan_diskon{

	private 
		$mekanisme_prosedur_diskon = "",
		$arr_diskon_id_saling_melengkapi = array(43),
		$arr_diskon_id_share_budget = array(43),
		$arr_diskon_id_sebudget = array(2,32,43),
		$diskon_id = 43,
	...
	function __construct( $arr_parameter, $readonly = "", $parameter_template = "", $arr_budget_diskon_tersedia_terkait = array() ){
		...
		$arr_rpl["#budget_terpakai_non_share#"] =  "<span style=\"border-bottom:3px red none\">" . 
						self::number_format_dec( $pemakaian_tq_freeitem ) . "<sup> [1]</sup></span> + ".  
						self::number_format_dec( $pemakaian_tq_diskon ) . "<sup> [2]</sup>";
		$arr_rpl["#keterangan_bqtq#"] = "<div style=\"font-size:11px; float:left\">
			...
			<sup>[2]</sup>. Pemakaian tambahan diskon potong TQ yang sedang dalam proses pengajuan<br />
