...
class mekanisme_prosedur_diskon_51 extends prosedur_khusus_tambahan_diskon{

	private 
		$mekanisme_prosedur_diskon = "",
		$arr_diskon_id_saling_melengkapi = array(51),
		$arr_diskon_id_share_budget = array(51),
		$arr_diskon_id_sebudget = array(51),
		$diskon_id = 51,
		$template = "template/diskon-bqtq#readonly#.html",
		$ada_yg_blm_dialokasikan = false,
		$prefiks_identifikasi_bqtq = "tt",
	...
	function __construct( $arr_parameter, $readonly = "", $parameter_template = "", $arr_budget_diskon_tersedia_terkait = array() ){
		...
		$pemakaian_tq = prosedur_khusus_tambahan_diskon::pemakaian_saldo( $arr_parameter["a.order_id"][1], $this->prefiks_identifikasi_bqtq )["pemakaian"];
		$budget_terpakai_non_share = $pemakaian_tq;
		$arr_rpl["#budget_terpakai_non_share#"] =  self::number_format_dec( $budget_terpakai_non_share )  . "<sup> [1]</sup>";
		$arr_rpl["#keterangan_bqtq#"] = "<div style=\"font-size:11px; float:left\">
			<sup>[1]</sup>. Pemakaian free item TT yang sedang dalam proses pengajuan<br />
			<sup>[2]</sup>. Pemakaian free item TT dari order lain yang sedang dalam proses pengajuan</div>";
		
		$pemakaian_tq_orderlain = prosedur_khusus_tambahan_diskon::pemakaian_saldo( $arr_parameter["a.order_id"][1], $this->prefiks_identifikasi_bqtq, false )["pemakaian"];
		$budget_terpakai_orderlain = $pemakaian_tq_orderlain;
		$arr_rpl["#budget_terpakai_order_lain#"] =  self::number_format_dec( $budget_terpakai_orderlain ) . "<sup> [2]</sup>";
