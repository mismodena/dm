...
<?= isset( $_REQUEST["diskon_pengajuan"] ) ? "<h3>Sedang Dalam Proses Pengajuan/Persetujuan Tambahan Diskon</h3>" : "" ?>
...
<input type="button" id="b_lanjut" value="- OK -" onclick="javascript:location.href='sales.php'" style="width:100%" />
<?
